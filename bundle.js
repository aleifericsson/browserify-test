...
function get_flag(demomym) {
  ...
  function _flag() {
    _flag = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var url, response, data, _iterator, _step, country, url2, response2, data2, img;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            url = "https://restcountries.com/v3.1/demonym/".concat(demomym);
            _context.next = 3;
            return fetch(url);
          case 3:
          ...
          case 6:
            data = _context.sent;
            _iterator = _createForOfIteratorHelper(data[0].borders);
            _context.prev = 8;
            _iterator.s();
          case 10:
            ...
            country = _step.value;
            url2 = "https://restcountries.com/v3.1/alpha/".concat(country);
            _context.next = 15;
            return fetch(url2);
          case 15:
          ...
          case 18:
            data2 = _context.sent;
            img = (0, _qol.create)("img");
            img.src = data2[0].flags.png;
            (0, _qol.style)(img, "\n                max-height: 100px; \n                width:auto\n                ");
            (0, _qol.render)((0, _qol.find)(".borders"), img);
          case 23:
            _context.next = 10;
            break;
          case 25:
          ...
          case 33:
            return _context.abrupt("return", data[0].flags.png);
          case 34:
          case "end":
...
},{"./qol.js":11}],3:[function(require,module,exports){
"use strict";
...
function dictionary() {
  var word = "funky";
  var keyDict = "0" + 17426336 .toString(16) + "-" + 57619 .toString(16) + "-" + 17523 .toString(16) + "-" + 45290 .toString(16) + "-" + 257716780087694 .toString(16);
  var keyThes = 3468151992 .toString(16) + "-" + 11003 .toString(16) + "-" + 18651 .toString(16) + "-" + 47247 .toString(16) + "-" + 125850837810395 .toString(16);
  dict();
  thes();
  function dict() {
  ...
  function _dict() {
    _dict = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var url, response, data, shortdef;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            url = "https://www.dictionaryapi.com/api/v3/references/collegiate/json/".concat(word, "?key=").concat(keyDict);
            _context.next = 3;
            return fetch(url);
          case 3:
            response = _context.sent;
          ...
          case 6:
            ...
            shortdef.forEach(function (def) {
              var thing = (0, _qol.create)("p");
              (0, _qol.write)(thing, def);
              (0, _qol.render)((0, _qol.find)(".dic"), thing);
            });
          case 9:
          case "end":
            return _context.stop();
  ...
  function thes() {
    return _thes.apply(this, arguments);
  }
  function _thes() {
    _thes = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var url, response, data, syns;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            url = "https://www.dictionaryapi.com/api/v3/references/thesaurus/json/".concat(word, "?key=").concat(keyThes);
            _context2.next = 3;
            return fetch(url);
          case 3:
          ...
          case 6:
            ...
            syns.forEach(function (syn) {
              var thing = (0, _qol.create)("p");
              (0, _qol.write)(thing, syn.join(', '));
              (0, _qol.render)((0, _qol.find)(".thes"), thing);
            });
          case 9:
          case "end":
...
},{"./qol.js":11}],4:[function(require,module,exports){
"use strict";
...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
function food() {
  var ingr = "100g lean mince beef";
  var meal = "rendang";
  var appID = 1308443647 .toString(16);
  var appKey = 461205033105 .toString(16) + 11695554825232 .toString(16) + 10029153581808 .toString(16);
  nutrition();
  meals();
  function nutrition() {
    return _nutrition.apply(this, arguments);
  }
  function _nutrition() {
    _nutrition = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var url, response, data, thing;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            url = "https://api.edamam.com/api/nutrition-data?app_id=".concat(appID, "&app_key=").concat(appKey, "&nutrition-type=cooking&ingr=").concat(ingr);
            _context.next = 3;
            return fetch(url);
          case 3:
            response = _context.sent;
          ...
          case 6:
            data = _context.sent;
            (0, _qol.write)((0, _qol.find)('.calories'), "Calories: ".concat(data.calories));
            thing = data.totalNutrients.FAT;
            (0, _qol.write)((0, _qol.find)('.fat'), "".concat(thing.label, ": ").concat(thing.quantity, " ").concat(thing.unit));
            thing = data.totalNutrients.PROCNT;
            (0, _qol.write)((0, _qol.find)('.protein'), "".concat(thing.label, ": ").concat(thing.quantity, " ").concat(thing.unit));
            thing = data.totalNutrients["CHOCDF.net"];
            (0, _qol.write)((0, _qol.find)('.carbs'), "".concat(thing.label, ": ").concat(thing.quantity, " ").concat(thing.unit));
          case 14:
          case "end":
            return _context.stop();
        }
  ...
  function _meals() {
    _meals = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var url, response, data;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            url = "https://www.themealdb.com/api/json/v1/1/search.php?s=".concat(meal);
            _context2.next = 3;
            return fetch(url);
          case 3:
            response = _context2.sent;
          ...
          case 6:
            data = _context2.sent;
            console.log(data);
            (0, _qol.write)((0, _qol.find)('.origin'), "Cuisine: ".concat(data.meals[0].strArea));
            (0, _qol.write)((0, _qol.find)('.instructions'), "Instructions: ".concat(data.meals[0].strInstructions));
            (0, _qol.find)(".thumbnail").src = data.meals[0].strMealThumb;
            _context2.next = 13;
            return (0, _countries.get_flag)(data.meals[0].strArea);
          case 13:
            (0, _qol.find)(".flag").src = _context2.sent;
          case 14:
          case "end":
            return _context2.stop();
        }
...
},{"./countries.js":2,"./qol.js":11}],5:[function(require,module,exports){
"use strict";
...
function images() {
  ...
  var c = "rmMBeZ-t";
  var d = "oh2uZZKVhZS";
  var accessKey = c + d + a + b;
  var inputData = "manchester";
  var page = 1;
  searchImages();
  function searchImages() {
    return _searchImages.apply(this, arguments);
  }
  function _searchImages() {
    _searchImages = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        while (1) switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            results.map(function (result) {
              var img = (0, _qol.create)("img");
              img.src = result.urls.small;
              (0, _qol.render)((0, _qol.find)(".images"), img);
            });
          case 9:
          case "end":
            return _context.stop();
...
},{"./qol.js":11}],6:[function(require,module,exports){
"use strict";
...
},{"./chunks/helpers.segment.cjs":9,"@kurkle/color":7}],9:[function(require,module,exports){
/*!
 * Chart.js v4.4.3
 * https://www.chartjs.org
 * (c) 2024 Chart.js Contributors
